...
import os, sys
sys.path.append('/DATA/jakaria_data/RADDI-514-Project/prepare')
from _classes import CTScan

RESOURCES_PATH = '/DATA/jakaria_data/resources'
OUTPUT_PATH = '/DATA/jakaria_data/tmp'

annotations = pd.read_csv(RESOURCES_PATH + '/annotations.csv')
candidates = pd.read_csv(RESOURCES_PATH + '/candidates_V2.csv')
