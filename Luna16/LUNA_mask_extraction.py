...
luna_path = "/DATA/jakaria_data/dataset/"
luna_subset_path = luna_path+"volumes/images/"
output_path = "/DATA/jakaria_data/dataset/volumes_modified/"
...
df_node = pd.read_csv("/DATA/jakaria_data/resources/annotations.csv")
